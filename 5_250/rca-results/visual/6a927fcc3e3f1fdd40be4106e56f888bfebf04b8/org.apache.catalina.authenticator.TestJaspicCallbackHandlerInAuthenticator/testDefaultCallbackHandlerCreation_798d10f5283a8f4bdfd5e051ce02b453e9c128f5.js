...
var source = {"current":
{
 "org.apache.catalina.authenticator.AuthenticatorBase.setJaspicCallbackHandlerClass_String":
 `/**
...
public static LogFactory getFactory() throws LogConfigurationException {
    return singleton;
}`,"org.apache.catalina.authenticator.jaspic.CallbackHandlerImpl.getInstance_":
...
var treeData = [
{
  ...
  "children" : [ {
    ...
    "children" : [ {
      ...
      "call" : "org.apache.catalina.authenticator.AuthenticatorBase#setJaspicCallbackHandlerClass",
      "kiekerPattern" : "public void org.apache.catalina.authenticator.AuthenticatorBase.setJaspicCallbackHandlerClass(java.lang.String)",
      "otherKiekerPattern" : null,
      "module" : "",
      "name" : "catalina.authenticator.AuthenticatorBase#setJaspicCallbackHandlerClass",
      "key" : "org.apache.catalina.authenticator.AuthenticatorBase.setJaspicCallbackHandlerClass_String",
      "otherKey" : null,
      "parent" : "org.apache.catalina.authenticator.TestJaspicCallbackHandlerInAuthenticator#testCallbackHandlerCreation",
      "color" : "#FFF",
      "statistic" : null,
      ...
      "children" : [ {
        ...
        "kiekerPattern" : "private new org.apache.catalina.authenticator.jaspic.CallbackHandlerImpl.<init>()",
        "otherKiekerPattern" : null,
        "module" : "",
        ...
        "call" : "org.apache.catalina.authenticator.jaspic.CallbackHandlerImpl#getInstance",
        "kiekerPattern" : "public static javax.security.auth.callback.CallbackHandler org.apache.catalina.authenticator.jaspic.CallbackHandlerImpl.getInstance()",
        "otherKiekerPattern" : null,
        "module" : "",
        "name" : "catalina.authenticator.jaspic.CallbackHandlerImpl#getInstance",
        "key" : "org.apache.catalina.authenticator.jaspic.CallbackHandlerImpl.getInstance_",
        "otherKey" : null,
        "parent" : "org.apache.catalina.authenticator.AuthenticatorBase#createCallbackHandler",
        "color" : "#FFF",
        "statistic" : null,
...
var margin = {top: 20, right: 120, bottom: 20, left: 686},
   width = 3808- margin.right - margin.left,
