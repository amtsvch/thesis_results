if (document.getElementById('testcaseDiv') != null) { 
   document.getElementById('testcaseDiv').innerHTML="Commit: <a href='javascript:fallbackCopyTextToClipboard(\"-commit 83fdd8b9662e9a58ba83dc99ce64c3f317e2643b -test org.apache.tomcat.util.http.TestCookieProcessorGeneration#testSameSiteCookies\")'>83fdd8b9662e9a58ba83dc99ce64c3f317e2643b</a><br>Test Case: org.apache.tomcat.util.http.TestCookieProcessorGeneration#testSameSiteCookies<br>";
}
...
}`,"org.apache.tomcat.util.http.SameSiteCookies.getValue_":
...
}`,"jakarta.servlet.http.Cookie.setHttpOnly_boolean":
 `/**
...
}`,"org.apache.tomcat.util.http.CookieProcessorBase.setSameSiteCookies_String":
...
}`,"org.apache.tomcat.util.http.SameSiteCookies.fromString_String":
...
}`,"jakarta.servlet.http.Cookie.getAttribute_String":
 `/**
...
}`,"jakarta.servlet.http.Cookie.setAttributeInternal_String_String":
...
}`,"org.apache.tomcat.util.http.TestCookieProcessorGeneration.testSameSiteCookies_":
 `@Test
...
}`,"jakarta.servlet.http.Cookie.setSecure_boolean":
 `/**
...
var treeData = [
{
  "call" : "org.apache.tomcat.util.http.TestCookieProcessorGeneration#testSameSiteCookies",
  "kiekerPattern" : "public void org.apache.tomcat.util.http.TestCookieProcessorGeneration.testSameSiteCookies()",
  "otherKiekerPattern" : null,
  "module" : "",
  "name" : "org.apache.tomcat.util.http.TestCookieProcessorGeneration#testSameSiteCookies",
  "key" : "org.apache.tomcat.util.http.TestCookieProcessorGeneration.testSameSiteCookies_",
  "otherKey" : null,
  "parent" : null,
  "color" : "#FFF",
  "statistic" : null,
  ...
  "children" : [ {
    ...
    "otherKey" : null,
    "parent" : "org.apache.tomcat.util.http.TestCookieProcessorGeneration#testSameSiteCookies",
    "color" : "#FFF",
    "statistic" : null,
    "hasSourceChange" : false,
    "state" : null,
    ...
    "children" : [ {
      ...
      "children" : [ {
        ...
        "kiekerPattern" : "boolean jakarta.servlet.http.CookieNameValidator.isToken(java.lang.String)",
        "otherKiekerPattern" : null,
        "module" : "",
    ...
    "children" : [ {
      ...
      "ess" : 2,
      "children" : [ {
        "call" : "jakarta.servlet.http.Cookie#getAttribute",
        "kiekerPattern" : "public java.lang.String jakarta.servlet.http.Cookie.getAttribute(java.lang.String)",
        "otherKiekerPattern" : null,
        "module" : "",
        "name" : "jakarta.servlet.http.Cookie#getAttribute",
        "key" : "jakarta.servlet.http.Cookie.getAttribute_String",
        "otherKey" : null,
        "parent" : "jakarta.servlet.http.Cookie#getPath",
        "color" : "#FFF",
        "statistic" : null,
        "hasSourceChange" : false,
        "state" : null,
      ...
      "children" : [ {
        ...
        "key" : "jakarta.servlet.http.Cookie.getAttribute_String",
        "otherKey" : null,
        "parent" : "jakarta.servlet.http.Cookie#getDomain",
        "color" : "#FFF",
        "statistic" : null,
        "hasSourceChange" : false,
        "state" : null,
      ...
      "children" : [ {
        ...
        "key" : "jakarta.servlet.http.Cookie.getAttribute_String",
        "otherKey" : null,
        "parent" : "jakarta.servlet.http.Cookie#getComment",
        "color" : "#FFF",
        "statistic" : null,
        "hasSourceChange" : false,
        "state" : null,
      ...
      "children" : [ {
        ...
        "key" : "jakarta.servlet.http.Cookie.getAttribute_String",
        "otherKey" : null,
        "parent" : "jakarta.servlet.http.Cookie#getMaxAge",
        "color" : "#FFF",
        "statistic" : null,
        "hasSourceChange" : false,
        "state" : null,
      ...
      "children" : [ {
        ...
        "key" : "jakarta.servlet.http.Cookie.getAttribute_String",
        "otherKey" : null,
        "parent" : "jakarta.servlet.http.Cookie#getSecure",
        "color" : "#FFF",
        "statistic" : null,
        "hasSourceChange" : false,
        "state" : null,
      ...
      "children" : [ {
        ...
        "key" : "jakarta.servlet.http.Cookie.getAttribute_String",
        "otherKey" : null,
        "parent" : "jakarta.servlet.http.Cookie#isHttpOnly",
        "color" : "#FFF",
        "statistic" : null,
        "hasSourceChange" : false,
        "state" : null,
      ...
      "call" : "org.apache.tomcat.util.http.SameSiteCookies#getValue",
      "kiekerPattern" : "public java.lang.String org.apache.tomcat.util.http.SameSiteCookies.getValue()",
      "otherKiekerPattern" : null,
      "module" : "",
      "name" : "org.apache.tomcat.util.http.SameSiteCookies#getValue",
      "key" : "org.apache.tomcat.util.http.SameSiteCookies.getValue_",
      "otherKey" : null,
      "parent" : "org.apache.tomcat.util.http.LegacyCookieProcessor#generateHeader",
      "color" : "#FFF",
      "statistic" : null,
    ...
    "call" : "org.apache.tomcat.util.http.CookieProcessorBase#setSameSiteCookies",
    "kiekerPattern" : "public void org.apache.tomcat.util.http.CookieProcessorBase.setSameSiteCookies(java.lang.String)",
    "otherKiekerPattern" : null,
    "module" : "",
    "name" : "org.apache.tomcat.util.http.CookieProcessorBase#setSameSiteCookies",
    "key" : "org.apache.tomcat.util.http.CookieProcessorBase.setSameSiteCookies_String",
    "otherKey" : null,
    "parent" : "org.apache.tomcat.util.http.TestCookieProcessorGeneration#testSameSiteCookies",
    "color" : "#FFF",
    "statistic" : null,
    ...
    "ess" : 1,
    "children" : [ {
      "call" : "org.apache.tomcat.util.http.SameSiteCookies#fromString",
      "kiekerPattern" : "public static org.apache.tomcat.util.http.SameSiteCookies org.apache.tomcat.util.http.SameSiteCookies.fromString(java.lang.String)",
      "otherKiekerPattern" : null,
      "module" : "",
      "name" : "org.apache.tomcat.util.http.SameSiteCookies#fromString",
      "key" : "org.apache.tomcat.util.http.SameSiteCookies.fromString_String",
      "otherKey" : null,
      "parent" : "org.apache.tomcat.util.http.CookieProcessorBase#setSameSiteCookies",
      "color" : "#FFF",
      "statistic" : null,
      "hasSourceChange" : false,
      "state" : null,
      ...
      "children" : [ {
        ...
        "key" : "org.apache.tomcat.util.http.SameSiteCookies.getValue_",
        "otherKey" : null,
        "parent" : "org.apache.tomcat.util.http.SameSiteCookies#fromString",
        "color" : "#FFF",
        "statistic" : null,
        "hasSourceChange" : false,
        "state" : null,
    ...
    "call" : "jakarta.servlet.http.Cookie#setSecure",
    "kiekerPattern" : "public void jakarta.servlet.http.Cookie.setSecure(boolean)",
    "otherKiekerPattern" : null,
    "module" : "",
    "name" : "jakarta.servlet.http.Cookie#setSecure",
    "key" : "jakarta.servlet.http.Cookie.setSecure_boolean",
    "otherKey" : null,
    "parent" : "org.apache.tomcat.util.http.TestCookieProcessorGeneration#testSameSiteCookies",
    "color" : "#FFF",
    "statistic" : null,
    ...
    "ess" : 1,
    "children" : [ {
      "call" : "jakarta.servlet.http.Cookie#setAttributeInternal",
      "kiekerPattern" : "private void jakarta.servlet.http.Cookie.setAttributeInternal(java.lang.String,java.lang.String)",
      "otherKiekerPattern" : null,
      "module" : "",
      "name" : "jakarta.servlet.http.Cookie#setAttributeInternal",
      "key" : "jakarta.servlet.http.Cookie.setAttributeInternal_String_String",
      "otherKey" : null,
      "parent" : "jakarta.servlet.http.Cookie#setSecure",
      "color" : "#FFF",
      "statistic" : null,
      "hasSourceChange" : false,
      "state" : null,
    ...
    "call" : "jakarta.servlet.http.Cookie#setHttpOnly",
    "kiekerPattern" : "public void jakarta.servlet.http.Cookie.setHttpOnly(boolean)",
    "otherKiekerPattern" : null,
    "module" : "",
    "name" : "jakarta.servlet.http.Cookie#setHttpOnly",
    "key" : "jakarta.servlet.http.Cookie.setHttpOnly_boolean",
    "otherKey" : null,
    "parent" : "org.apache.tomcat.util.http.TestCookieProcessorGeneration#testSameSiteCookies",
    "color" : "#FFF",
    "statistic" : null,
    ...
    "children" : [ {
      ...
      "key" : "jakarta.servlet.http.Cookie.setAttributeInternal_String_String",
      "otherKey" : null,
      "parent" : "jakarta.servlet.http.Cookie#setHttpOnly",
      "color" : "#FFF",
      "statistic" : null,
      "hasSourceChange" : false,
      "state" : null,
...
var margin = {top: 20, right: 120, bottom: 20, left: 539},
   width = 2575- margin.right - margin.left,
